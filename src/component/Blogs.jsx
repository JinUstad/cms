                        ...
                        blogs.data.map((blog) => (
                            <div className="col-md-4">
                                ...
                                <div className="card w-100">
                                    {/* <img src={blog.coverImg} className="card-img-top" alt="..." /> */}
                                    <img src={`http://localhost:1337${blog.coverImg.url}`} className="card-img-top" alt="..." />
                                    <div className="card-body">
                                        <h5 className="card-title">{blog.blogTitle}</h5>
                                        <p className="card-text">{blog.blogDesc}</p>
